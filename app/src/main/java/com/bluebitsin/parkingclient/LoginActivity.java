    ...
    private void login(){
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String userId = "999999999";//editTextUserId.getText().toString();
                String password = "tigerleo";//editTextPassword.getText().toString();
        ...
        call.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                ...
                if(responseCode == 200){
                    ...
                    // user not found
                    Toast.makeText(LoginActivity.this, "Invalid UserId and Password, Please Try Again.", Toast.LENGTH_SHORT).show();
                }
